...
type HeraldData struct {
	...
	Label        string               `protobuf:"bytes,2,opt,name=label,proto3" json:"label,omitempty"`                                                                                        // the run or sample name
	History      []*Comment           `protobuf:"bytes,3,rep,name=history,proto3" json:"history,omitempty"`                                                                                    // describes the history of the run
	Status       Status               `protobuf:"varint,4,opt,name=status,proto3,enum=services.Status" json:"status,omitempty"`                                                                // describes if untagged/tagged/announced
	Tags         map[string]bool      `protobuf:"bytes,5,rep,name=tags,proto3" json:"tags,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"` // tagged services and their complete status (true=complete, false=incomplete)
	RequestOrder []string             `protobuf:"bytes,6,rep,name=requestOrder,proto3" json:"requestOrder,omitempty"`                                                                          // the order to send requests to the tagged services
}
...
var file_herald_proto_rawDesc = []byte{
	...
	0x78, 0x74, 0x22, 0xc0, 0x02, 0x0a, 0x0a, 0x48, 0x65, 0x72, 0x61, 0x6c, 0x64, 0x44, 0x61, 0x74,
	0x61, 0x12, 0x34, 0x0a, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x07,
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c,
	...
	,
...
var file_herald_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_herald_proto_goTypes = []interface{}{
	(Status)(0),                 // 0: services.Status
	(*Comment)(nil),             // 1: services.Comment
	(*HeraldData)(nil),          // 2: services.HeraldData
	(*Run)(nil),                 // 3: services.Run
	(*Sample)(nil),              // 4: services.Sample
	nil,                         // 5: services.HeraldData.TagsEntry
	(*timestamp.Timestamp)(nil), // 6: google.protobuf.Timestamp
}
var file_herald_proto_depIdxs = []int32{
	6, // 0: services.Comment.timestamp:type_name -> google.protobuf.Timestamp
	6, // 1: services.HeraldData.created:type_name -> google.protobuf.Timestamp
	1, // 2: services.HeraldData.history:type_name -> services.Comment
	0, // 3: services.HeraldData.status:type_name -> services.Status
	5, // 4: services.HeraldData.tags:type_name -> services.HeraldData.TagsEntry
	2, // 5: services.Run.metadata:type_name -> services.HeraldData
	2, // 6: services.Sample.metadata:type_name -> services.HeraldData
